<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#" class="active"><i class="fa fa-dashboard fa-fw fa-3x"></i> Dashboard</a>
            </li>
            <li>
                <a href="#"><i class="fa fa-envelope fa-fw fa-3x"></i> Bus Stops<span class="fa arrow"></span></a>
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw fa-3x"></i> Routes<span class="fa arrow"></span></a>
                <!--<ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="#"><i class="fa fa-th fa-fw fa-3x"></i> Buses</a>
            </li>
            <!--<li>
